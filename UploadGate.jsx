...
export const UploadGate = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-zinc-900/60 backdrop-blur border border-emerald-500/20 rounded-3xl text-center space-y-4 m-4 shadow-xl shadow-emerald-900/10">
      ...
      <p className="text-zinc-400 text-sm max-w-xs">
        {lang === 'en' ? 'Supported formats: WAV, MP3, M4A, OGG' : 'الصيغ المدعومة: WAV, MP3, M4A, OGG'}
      </p>
